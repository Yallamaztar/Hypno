...
type Repository interface {
	Create(name, xuid, guid string, level int, iw4mID *int) (int, error)
...
func (r *repository) Create(name, xuid, guid string, level int, iw4mID *int) (int, error) {
	res, err := r.db.Exec(queries.CreatePlayer, name, xuid, guid, level, iw4mID)
	if err != nil {
		return 0, err
	}
...
func (r *repository) GetByDiscordID(id string) (*Player, error) {
	var p Player
